...
<body>
    <section class="authorization">
        ...
        <div class="authorization__main">
            <div class="authorization__main__form">
                ...
                <p>Пароль</p><br>
                <input type="text" id="password" name="password" class="authorization__main__form__input"><br>
    ...
    @if ($remember_token)
    <script>
        async function authTocken() {
            let user = {
                remember_token: <?= "'" . $remember_token . "'" ?>,
            };
            console.log(user);
            let response = await fetch('http://127.0.0.1:8000/api/authTocken', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json;charset=utf-8'
                },
